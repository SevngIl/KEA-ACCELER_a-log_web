            ...
            <FloatingWrapper width={"200px"} height={"500px"} className="container">
                ...
                <div className="planning_container">
                    ...
                    <div className="Timeline">
                        <Button variant="outline-primary" onClick={() => navigate(`/${projectPk}/Timeline`)}>
                            TimeLine
                        </Button>
                    </div>
                    <div className="Board">
                        <Button variant="outline-primary" onClick={() => navigate(`/${projectPk}/Board`)}>
                            Board
                        </Button>
                    </div>
                </div>
                ...
                <div className="release_container">
                    ...
                    <div className="Notes">
                        <Button variant="outline-primary" onClick={() => navigate(`/${projectPk}/ReleaseNote`)}>
                            Notes
                        </Button>
                    </div>
                </div>
